...
<table id="tabel-tampil">
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        if($pencarian != ""){
            $sql = "SELECT * FORM tbanggota WHERE nama LIKE '%$pencarian%'
    ...
    if(mysqli_num_rows($q_tampil_anggota)>0)
    {
        ...
        <tr>
            ...
            <td><img scr="images/<?php echo $foto; ?>" width=70px height=70px></td>
            <td><?php echo $r_tampil_anggota['jeniskelamin']; ?></td>
            <td> <?php echo $r_tampil_anggota['alamat']; ?></td>
            <td>
                <div class="tombol-opsi-container">
                    <a terget="_blank" href="pages/cetak_kartu.php?id=<?php echo $r_tampil_anggota['idanggota'];?>" class="tombol"> Cetak Kartu</a>
                </div>
                <div class="tombol-opsi-container">
                ...
                <div class="tombol-opsi-container">
                    ...
                    onclick ="return_confirmation('Apakah Anda Yakin Akan Mengahpus Data Ini?')" class="tombol">Hapus<a></div>
            </td>
        </tr>
        <?php $nomor++;}
    }
