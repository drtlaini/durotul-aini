...
<table id="tabel-tampil">
    ...
    if(mysqli_num_rows($q_tampil_buku)> 0)
    {
        ...
        <tr>
            ...
            <td><?php echo $q_tampil_buku['id_buku']; ?></td>
            <td> <?php echo $q_tampil_buku['judul_buku']; ?></td>
            <td><?php echo $q_tampil_buku['kategori']; ?></td>
            <td> <?php echo $q_tampil_buku['pengarang']; ?></td>
            <td> <?php echo $q_tampil_buku['penerbit']; ?></td>
